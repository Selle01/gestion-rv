...
class RendezVousController
{
    ...
    public function __construct(Router $router, RendererInterface $renderer, SessionInterface $session)
    {
        ...
        $this->service_id = $this->session->get('auth.user') !== null ? $this->session->get('auth.user')->getServiceId() : null;
        // $this->specialty_id = $this->session->get('auth.user') !== null ? $this->session->get('auth.user')->getSpecialtyId() : null;
    ...
    public function index(): string
    {
        ...
        $medecins =  $this->rendezVousDao->listofMedecin($this->service_id);
        $patients =  $this->rendezVousDao->listofPatient();
        $secretaries =  $this->rendezVousDao->listofSecretary($this->service_id);
